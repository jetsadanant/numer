...
//             tag += '"x'+(i+1)+'": '+x[i]+', "error'+(i+1)+'": ' + error[i];
//             if (i !== x.length-1) {
//                 tag += ','
//             }
//         }
...
//                 <h1 style={{ textAlign: 'center',fontSize:'30px'}}>Gauss-Seidel</h1>
//                 <div className="row">
...
//                                 <div>
//                                     <h4>Row : <Input size="large" name="row"value={this.state.row}style={{ width: 500 }}></Input></h4>
//                                     <h4>Column : <Input size="large" name="column"  value={this.state.column} style={{ width: 500 }}></Input></h4>
...
//                                     <br />
//                                     <Button  size="large" id="matrix_button"  
//                                         style={{ width: 150 ,background: "#f7c602", color: "black"}}
//                                         onClick={()=>this.seidel(parseInt(this.state.row))}>Submit
//                                     </Button>
//                                 </div>
//                             }
...
//                             id="outputCard"
//                             >
//                                 <Table columns={column} dataSource={dataInTable} bordered={true} bodyStyle={{fontWeight: "bold", fontSize: "18px", color: "black", overflowX: "scroll"}}
//                                 ></Table>
//                             </Card>
//                         }                           
//                     </div>
